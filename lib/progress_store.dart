...
class ProgressStore extends ChangeNotifier {
  ...
  static const _bombUsesKey = 'progress.toolUses.bomb';
  static const _plusUsesKey = 'progress.toolUses.plus';
  static const _targetUsesKey = 'progress.toolUses.target';
  static const _soundMutedKey = 'settings.soundMuted';
  static const _musicMutedKey = 'settings.musicMuted';
  static const _tutorialCompletedKey = 'progress.tutorialCompleted';
  ...
  Future<void> load() async {
    ...
    final savedLevel = _preferences!.getInt(_levelKey) ?? level;
    level = savedLevel.clamp(1, 500);
    coins = _preferences!.getInt(_coinsKey) ?? coins;
    hearts = _preferences!.getInt(_heartsKey) ?? hearts;
    bombUses = _preferences!.getInt(_bombUsesKey) ?? bombUses;
    plusUses = _preferences!.getInt(_plusUsesKey) ?? plusUses;
    targetUses = _preferences!.getInt(_targetUsesKey) ?? targetUses;
    soundMuted = _preferences!.getBool(_soundMutedKey) ?? soundMuted;
    musicMuted = _preferences!.getBool(_musicMutedKey) ?? musicMuted;
    tutorialCompleted =
        _preferences!.getBool(_tutorialCompletedKey) ?? tutorialCompleted;
  ...
  Future<void> save() async {
    ...
    await Future.wait([
      ...
      _preferences!.setInt(_bombUsesKey, bombUses),
      _preferences!.setInt(_plusUsesKey, plusUses),
      _preferences!.setInt(_targetUsesKey, targetUses),
      _preferences!.setBool(_soundMutedKey, soundMuted),
      _preferences!.setBool(_musicMutedKey, musicMuted),
      _preferences!.setBool(_tutorialCompletedKey, tutorialCompleted),
