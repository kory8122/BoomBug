...
class _MenuScreenState extends State<MenuScreen> with TickerProviderStateMixin {
  ...
  Future<void> _openGame() async {
    ...
    if (!_progress.tutorialCompleted) {
      Navigator.of(context).pushReplacement(
        MaterialPageRoute(
          builder: (_) => const GameSplashScreen(isTutorial: true),
        ),
      );
      return;
    }
  ...
  Future<void> _toggleMusic() async {
    await _audio.toggleMusic(startMusic: false);
    if (!mounted) return;
    setState(() {
      _isMusicMuted = _audio.musicMuted;
  ...
  Future<void> _showLevelPickerDialog() async {
    final currentLevel = _progress.level.clamp(1, _totalLevels);
    final maxUnlockedLevel = _totalLevels;
    var selectedLevel = currentLevel.clamp(1, maxUnlockedLevel);
      ...
      builder: (dialogContext) {
        return StatefulBuilder(
          builder: (context, setDialogState) {
            final selectionLocked = selectedLevel > maxUnlockedLevel;
            final buttonOpacity = selectionLocked ? 0.45 : 1.0;
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            'Unlocked: $maxUnlockedLevel / $_totalLevels',
                            style: const TextStyle(
                              color: Color(0xFF3A2A5E),
                              fontWeight: FontWeight.w800,
                              fontSize: 12,
                        ...
                        children: [
                          ...
                          ListWheelScrollView.useDelegate(
                            controller: FixedExtentScrollController(
                              initialItem: (selectedLevel - 1).clamp(
                                0,
                                _totalLevels - 1,
                              ),
                            ),
                            ...
                            childDelegate: ListWheelChildLoopingListDelegate(
                              children: List<Widget>.generate(_totalLevels, (
                                index,
                              ) {
                                final levelNumber = index + 1;
                                final isUnlocked =
                                    levelNumber <= maxUnlockedLevel;
                                final isSelected = levelNumber == selectedLevel;
                                return Center(
                                  child: Text(
                                    '$levelNumber',
                                    style: TextStyle(
                                      color: isUnlocked
                                          ? (isSelected
                                                ...
                                                : const Color(0xFF7D5CB0))
                                          : const Color(0xFFB7A7D8),
                    ...
                    Text(
                      'Choose a level from 1 to $_totalLevels',
                      style: const TextStyle(
                        color: Color(0xFF3A2A5E),
                        fontSize: 12,
                        ...
                        Opacity(
                          ...
                          child: ElevatedButton(
                            style: ElevatedButton.styleFrom(
                              ...
                              foregroundColor: const Color(0xFF3A2A5E),
                              padding: const EdgeInsets.symmetric(
                                horizontal: 20,
                                vertical: 12,
                              ),
